<template>
    <div>
        ...
        <p>As we annotated the acqusitions of objects over many years, it made sense to develop a tool which can be used to analyze the more consistent entities over the years more abstractly. It turned out that suppliers, original locations and the receiving collections are the most consistent information points. With the search bar below you can search for entities of either one of the three and get an overview of which of the entities of the other two types are connected to it over the years.</p>
        ...
        <div class="modeselection">
            <p class="mode" :style="[mode === 0 ? focusStyle : unFocusStyle]" @click="navigate(0)">Suppliers</p>
