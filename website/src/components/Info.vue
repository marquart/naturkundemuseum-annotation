<template>
    <div class="text">
        <h3>Approach and Aim</h3>
            ...
            <ul>
                <li>produce semantic annotations of the text using the <a href="https://cidoc-crm.org" target="_blank">CIDOC Conceptual Reference Model (CRM)</a> developed by the International Committee for Documentation (CIDOC) of the International Council of Museums (ICOM),</li>
        ...
        <h3>Status</h3>
            <p>All information found in the Chronik related to acquisitions of new objects by the Zoological Museum is annotated. In over 7500 annotated lines of over 32000 lines in total we processed nearly 39000 semantic entities. In this initial step, we tried to model the data as close to the source as possible – meaning that we neither validated the statements the authors made nor critically contextualised problematic terms related to racism and colonialism.</p>

            <p>12066 of the identified semantic entities portray individual acquisition of objects. The remaining entities are mostly connected to these acquisitions to describe each of the acquisitions in more detail and can be categorised this way:</p>
            <table class="table90">
                ...
                <tr><td>Receiving collection</td><td class="right">12058</td><td class="right">99.9%</td><td>
                    <span class="entityLink" @click="emitDisplayTextOf('4706')">Arachnoidea</span>, <span class="entityLink" @click="emitDisplayTextOf('24160')">Würmer</span></td></tr>
                <tr><td>Location</td><td class="right">9510</td><td class="right">78.8%</td><td><span class="entityLink" @click="emitDisplayTextOf('44678')">Deutsch-Neuguinea</span>, <span class="entityLink" @click="emitDisplayTextOf('10362')">Tanganjika-See</span></td></tr>
                <tr><td>Supplier</td><td class="right">9462</td><td class="right">78.4%</td><td><span class="entityLink" @click="emitDisplayTextOf('44753')">Bezirksamtmann Dr. Reuß</span>, <span class="entityLink" @click="emitDisplayTextOf('44728')">Fräulein Tomala</span></td></tr>
                <tr><td>Taxon</td><td class="right">983</td><td class="right">8.1%</td><td><span class="entityLink" @click="emitDisplayTextOf('42815')">Aktinien</span>, <span class="entityLink" @click="emitDisplayTextOf('47549')">Ichneumoniden</span></td></tr>
                <tr><td>Dimension</td><td class="right">844</td><td class="right">7.0%</td><td><span class="entityLink" @click="emitDisplayTextOf('17545')">zahlreiche</span>, <span class="entityLink" @click="emitDisplayTextOf('45881')">vier</span></td></tr>
                <tr><td>Condition State/ Condition Assessment</td><td class="right">290</td><td class="right">2.4%</td><td><span class="entityLink" @click="emitDisplayTextOf('44695')">wertvoll</span>, <span class="entityLink" @click="emitDisplayTextOf('38580')">äußerst selten</span></td></tr>
            </table>
            ...
            <p>The acquisitions were categorised into three types, according to their descriptions in the text as “Gift”, “Purchase”, or “Trade”. A transaction is either classified as purchase if the supplier gets an amount of money in return for the objects or as trade if the supplier gets other objects or services from the museum in return for their objects or finally as gift if the supplier gets no apparent compensation in return for their objects. These three types are distributed like this:</p>
            <table class="table60">
            ...
            <p>The annotated data is modelled in a <strong>knowledge graph</strong>. Every semantic entity is connected to at least another semantic entity via a labeled edge in order to preserve the context the entity is embedded in. The labels for classifying semantic entities and these so called properties are defined in the ontology of the <a href="https://cidoc-crm.org" target="_blank">CIDOC Conceptual Reference Model (CRM)</a>.</p>
            ...
            <p>We decided to enrich the knowledge graph with <strong>artificial entities</strong> which have no explicit position in the source text because of:</p>
            <ol>
                <li>
